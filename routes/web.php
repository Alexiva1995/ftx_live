...
Route::group(['prefix' => 'installer'], function (){
  ...
  Route::get('courses/category/{id}', 'CourseController@show_course_category')->name('show.cursos.category');
  //Perfil del mentor
  Route::get('courses/mentor/{id}', 'CourseController@perfil_mentor')->name('show.perfil.mentor');

  /*** RUTAS PARA EL CARRITO DE COMPRA***/
  Route::group(['prefix' => 'shopping-cart'], function(){
    Route::get('/', 'ShoppingCartController@index')->name('shopping-cart.index');
    Route::get('store/{id}/{type?}/{period?}', 'ShoppingCartController@store')->name('shopping-cart.store');
  ...
  Route::get('change-meeting-status/{evento}', 'EventsController@change_meeting_status');
  ...
  Route::post('/survey/statistics', 'SetEventController@survey_statistics')->name('survey.statistics');
  ...
  Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'licencia', 'menu']], function() {
    ...
    Route::group(['prefix' => 'entradas'], function(){
        ...
        Route::get('/soporte/ticket/solved','SoporteController@ticket_solved')->name('soporte.tickets.solved');
