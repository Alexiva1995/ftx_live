        ...
        <div class="carousel-inner">
            <div class="carousel-item  active ">
              <div class="overlay"></div>
                  ...
                  <div class="blog-title font-weight-bold">BLOG | FTX LIVE
               </div>
              </div>
          </div>
        </div>
      ...
      @foreach($entradas as $entra)
        <div class="col-md-3" style="box-shadow: 0 2px 4px rgba(0,0,0,.2); margin-bottom: 20px; margin-bottom: 20px; margin-right: 25px;">
            ...
            <div class="card-body" style="background-color: #FFFFFF;">
                <div class="card-title" style="color: #CF202F; padding-left: 0px; font-size: 20px !important; font-weight: 700!important; line-height: 26px; height: 90px;">{{$entra->titulo}}</div>
                <div style="font-size: 14px; color: #8B8E9D; ine-height: 16px; height: 180px;">{!! $entra->descripcion !!}</div>
                <a class="btn btn-danger btn-block" href="{{ route('blog.articulo', $entra->id) }}">¡VER ARTÍCULO!</a>
