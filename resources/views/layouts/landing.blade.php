                                    ...
                                    <div class="row">
                                        <div class="col-md-12 py-5">
                                            ...
                                            <div class="mb-25 text-center">
                                                ...
                                                <img src="{{ asset('images/logo-jose.png')}}" alt="" height="50px" class="mr-4 ml-4 mb-3">
                                            ...
                                            <div class="text-center text-white" style="margin-top: 20px;">
                                                <a href="{{ asset('policies.pdf') }}" class="text-white" target="_blank" style="padding: 2px;">Pol&iacute;ticas de Uso</a> &nbsp&nbsp
