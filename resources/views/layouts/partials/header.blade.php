<!--<nav class="navbar navbar-expand-lg navbar-dark bg-dark-gray border-bottom" style="height: 70px;flex-wrap: nowrap!important;">
        ...
        <div class="col-md-12 col-md-12 pt-2">
             <a href="#" target="_blank" class="btn float-right"><i class="text-white fa fa-facebook-f fa-1x"></i></a>
             <a href="#" class="btn float-right" target="_blank"><i class="text-white fa fa-twitter fa-1x"></i></a>
             <a href="#" target="_blank" class="btn float-right"><i class="text-white fa fa-instagram fa-1x"></i></a>
