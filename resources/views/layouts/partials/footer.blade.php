...
<div class="section-paises" style="background:#B70F1E!important;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="#" target="_blank" class="btn btn-footer-yt btn-footer-redes "><i class="text-white fa fa-youtube fa-2x"></i></a>
                                    ...
                                    <a href="https://twitter.com/ftxlive" class="btn btn-footer-tw btn-footer-redes " target="_blank"><i class="text-white fa fa-twitter fa-2x"></i></a>
                            ...
                            <div class="mb-2 text-center text-white" style="margin-top: 20px;">
                                    <img src="{{ asset('images/logo.png') }}" style="" class="img-fluid"> <strong>2020 FTX Live</strong> All Rigth Reserved
                            </div>
