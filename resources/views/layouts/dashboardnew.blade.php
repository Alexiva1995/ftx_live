...
<html lang="{{ app()->getLocale() }}">
   ...
   @if($settings->traductor == '1')    
      ...
      <script type="text/javascript">
         function googleTranslateElementInit(){
            new google.translate.TranslateElement({
               pageLanguage: 'es', 
               includedLanguages: 'de,en,fr,pt,zh-CN,es,ja,it,ru', 
      ...
      <script type="text/javascript"bsrc="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script> 
   @endif
   {{-- fin traductor --}}
   ...
   @else
      <body class="hold-transition skin-blue sidebar-mini">
         ...
         <form action="https://streaming.ftxlive.com/connect-mba/0/{{Auth::user()->ID}}" method="POST" target="_blank" name="express_event_form">
            @csrf
