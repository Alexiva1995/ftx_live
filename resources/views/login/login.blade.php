...
<style>
    ...
    .nav-tabs .nav-link:hover {
        border-color: #CF202F #CF202F #CF202F;
        color: #333;
    }
...
<center>
    <img src="{{asset('/images/FTXlive-logo.png')}}" style="width: 200px; margin-top: 80px; margin-bottom: 40px;">
</center>
    ...
    border-top-right-radius: 1.25rem; padding: 12px;">Registro</a>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade {{(request()->act == 0) ? 'active show' : ' '}}" id="acceso" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form class="login-form" method="POST" action="{{ route('autenticar') }}" name="formulario">
                            ...
                            <div class="form-group has-feedback" style="margin-top:10px;">
                                <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">Número de Afiliación</label>
                                <input type="number" class="form-control" name="ID" value="{{old('ID')}}" style="border-radius: 20px;">
                            </div>

                            <div class="form-group has-feedback" style="margin-top:10px;">
                                <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">Contraseña</label>
                    ...
                    <div class="row" style="margin-top: 10px; ">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-dark btn-block" style="border-radius: 20px; padding: 10px;">Acceder</button>
                        </div>
                    </div>
                    <br>
                ...
                <div class="tab-pane fade {{(request()->act == 1) ? 'active show' : ' '}} " id="registro" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form class="login-form" method="POST" action="{{ route('autenticacion.save-register') }}" name="formulario">
                        ...
                        <div class="form-group has-feedback">
                            <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">Usuario</label>
                            <input type="text" class="form-control" name="nameuser" value="{{old('nameuser')}}" style="border-radius: 20px;">
                        </div>

                        <div class="form-group has-feedback">
                            <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">Correo Electronico</label>
                        ...
                        <div class="form-group has-feedback">
                            <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">Confirmar contraseña</label>
                            <input type="password" class="form-control" name="password_confirmation" ID="txtPassword" style="border-radius: 20px;">
                        </div>

                        @if(empty(request()->ref))
                            <div class="form-group has-feedback">
                            <label for="patrocinador" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">ID Patrocinador (Si no sabe cual es su patrocinador por favor coloque el ID 1)</label>
                        ...
                        <div class="form-group has-feedback">
                            <label for="usr" style="font: 16px sans-serif; color:#1C1D21; font-weight:bold;">País</label>
