        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" id="store_file_form">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" onclick="newFile();" id="store_file_submit">Enviar</a>
                    <button class="btn btn-danger" type="button" disabled id="store_file_loader" style="display: none;">
