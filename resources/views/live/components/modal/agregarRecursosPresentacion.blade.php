        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" id="store_presentation_form">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" onclick="newPresentation();" id="store_presentation_submit">Enviar</a>
                    <button class="btn btn-danger" type="button" disabled id="store_presentation_loader" style="display: none;">
