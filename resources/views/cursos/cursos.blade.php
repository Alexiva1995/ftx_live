...
@section('content')
    ...
    @if (!Auth::guest())
        <div class="title-page-course col-md"><span class="text-white">
            <h3><span class="text-white">Hola</span><span class="text-danger"> {{$username}}</span><span class="text-white"> ¡Nos alegra verte hoy!</span></h3>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class="text-white text-uppercase ml-4 text-center" style="font-size: 12px;">
                     ...
                     <div class="col-md-12">
                        <a href="{{ route('lesson.show', [$leccion_info->slug, $leccion_info->id, $last_course->course_id]) }}"  class="btn btn-danger float-right text-uppercase btn-block m-2" style="font-size: 12px;"><i class="fa fa-play"></i> Continuar curso</a>
                    </div>
                    ...
                    <div class="">
                        <div class="row p-0">
                            ...
                            <div class="col-md-2 float-right mb-2">
                                <div class="row">
                                     <a href="{{ route('lesson.show', [$leccion_info->slug, $leccion_info->id, $last_course->course_id]) }}"  class="btn btn-danger float-right text-uppercase mr-4"><i class="fa fa-play"></i> Continuar curso</a>
                                </div>
                    ...
                    <div class="wrapper">
                            ...
                            <div class="card m-2 mb-4 card-courses">
                                ...
                                <div class="row d-flex align-items-center body-miscursos">
                                    ...
                                    <div class="col-3 p-2 d-flex align-items-center d-none d-sm-none d-md-block icon-miscursos"><img src="{{ asset('images/icons/play-button.svg') }}" alt="" height="15px" width="15px"></div>
                                </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                                <div class="row h-100">
                                        <div class="card-block w-50 text-danger align-self-center">
                                            <a href="{{ route('client.my-courses') }}" class="text-danger font-weight-bold">Ver todos mis cursos</a>
                                            <i class="text-danger fa fa-arrow-right"></i>
                                        </div>
...
<div class="section-landing mt-3" style="background-color: #121317;">
    ...
    <div class="col">
            @if (Auth::guest())
                <h3><span class="text-danger">Recomendados</span></h3>
            @else
                <h3><span class="text-danger">Recomendados</span><span class="text-white"> según tus intereses.</span></h3>
            @endif
        </div>
                        ...
                        <div class="col-sm-4 d-inline-flex p-2">
                            ...
                            <div class="course-category-caption ml-1 mr-1">
                                <div class="col-sm-lg text-sm-left font-weight-bold">
                                    <a href="{{ url('courses/category/'.$course->id) }}" class="col-sm-lg text-sm-left  text-danger">{{$course->title}}</a>
                                </div>
                                <div class="col-lg">
